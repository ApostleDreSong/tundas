      ...
      <div className="">
        ...
        <div className="">
          <section className="container pt-6 lg:pt-16">
            <p className="mb-8 text-[#0A002E] text-5xl font-bold">
              Core Values
            </p>
            <hr
              style={{
                  ...
                  <div className="w-full lg:w-1/4 flex flex-row bg-custom-two bg-no-repeat bg-right-top pt-10">
                    <div>
                      ...
                      <p className="text-base text-custom-body font-normal">
                        ...
                        relationships. We maintain the highest ethical
                        standards.
                      </p>
                    </div>
                  </div>
          ...
          <div className="bg-custom-grey">
            <div className="bg-[#FCFBFE] rounded-b-[5.25rem] ">
              <section className="container flex flex-col py-28">
                <div className="text-center pb-16">
                  <p className="text-5xl font-bold text-[#0A002E]">
                    Meet the Team
                  </p>
                </div>
